...
const Login = () => {
  const [userName, setUserName] = useState('Yan Naing Htwe');
  const [email, setEmail] = useState('yannainghtwe.777.yy@gmail.com');
  ...
  const formSubmit = (e) => {
    ...
    userName !== 'Yan Naing Htwe' &&
      notify('error', 'User Name should be Yan Naing Htwe');
    setTimeout(() => {
      setUserName('Yan Naing Htwe');
      return;
    }, 2000);
